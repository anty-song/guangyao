...
class WaterFlower extends  GameLobby
{
    ...
    public function home()
    {
        ...
        $memcache_key = 'game_roll_user_list_4';
...
//                $new_user_list[$k]['roll_title'] = htmlspecialchars('恭喜<span style="color:blue;">'.$v['name'].'</span>中了<span style="color:red;">'.$v['money'].'</span>元');
//            }
