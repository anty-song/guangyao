...
class WaterFlower extends BaseController
{
    protected $game_model;
    protected $game_id = 4;//浇花游戏ID
    ...
    {
        $game_config = $this->game_model->getGameConfigPro($this->game_id,'again_count,type1_radio,type2_radio');// 获取相关配置数据
        ...
        return $this->fetch('game/waterflower/home');
    }
